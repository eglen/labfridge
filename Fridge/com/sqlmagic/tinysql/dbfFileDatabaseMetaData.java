  ...
  private final String emptyString = "";
     ...
     */
      public ResultSet getTypeInfo() throws SQLException {
        tsResultSet jrs = new tsResultSet(null, null, null, null);
         ...
         for ( int itype=0; itype < types.length; itype++ )
         {
            ...
            for ( i = 0; i < vec.size(); i++)
            {
               ...
               if ( tableNamePattern.equals("%") |
                   tableName.indexOf(tableNamePattern) >= 0)
               {
...
//      Several parameters missing.
        ...
        while (tableRs.next()) { // process each DBF file and extract column info ...
          ...
          for (java.util.Enumeration e = column_info.elements(); e.hasMoreElements() ;) {
            tsColumn tsc = (tsColumn)e.nextElement();
            ...
            record.put("COLUMN_NAME", tsc.name);
